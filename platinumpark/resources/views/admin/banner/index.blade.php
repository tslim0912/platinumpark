        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                {{-- <div class="visible-md-block visible-lg-block">
                    <a href="{{ route('admin.banner.create') }}" type="button" class="btn btn-info">
                        ...
                        <table id="banner-table" class="table table-bordered table-striped dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary" href="{{ route('admin.banner.show', ['banner'=>$value->id]) }}"><i class="fas fa-eye"></i> View</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
